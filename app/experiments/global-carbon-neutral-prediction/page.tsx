      ...
      <Card className="mb-4">
        ...
        <CardContent>
          <div className="flex flex-col gap-4">
            ...
            <div className="h-[600px] w-full bg-gray-100 rounded-md mt-4">
              <CarbonEmissionMap 
                mapStyle={mapStyle}
          ...
          <Tabs defaultValue="intro">
            ...
            <TabsContent value="guide" className="mt-4">
              <div className="space-y-4">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li><strong>地图类型切换</strong>：可在"暗色地图"、"亮色地图"和"卫星影像"之间切换底图样式</li>
            ...
            <TabsContent value="theory" className="mt-4">
              <div className="space-y-4">
                ...
                <p>空间可视化方法有助于识别碳排放的空间模式，包括"热点"地区、"冷点"地区以及空间转移趋势，为精准减排提供支持。</p>
              </div>
            </TabsContent>
          </Tabs>
        </CardContent>
